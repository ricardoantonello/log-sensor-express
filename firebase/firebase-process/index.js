 ...
 * been placed in the "/home/pi" directory, and named "./firebase_key.json"
...
admin.initializeApp({
    ...
    databaseURL: 'https://log-sensor-express.firebaseio.com'
})
...
setInterval(()=>{
    ...
    */
    getSensorReadings((err, temperature, humidity)=>{
         ...
         */
        console.log('Temperatura atualizada. Temp: '+temperature+' Humid: '+humidity)
